...
import src.streamlit_src.hybrid_esn_streamlit.esn_build_train_predict as esn
...
if __name__ == '__main__':
    ...
    if advanced_mode:
        with more_tab:
            ...
            if status_dict[status_name]:
                ...
                # r_gen_dict = {"r_gen_train": res_train_dict["rgen"],
                #               "r_gen_pred": res_pred_dict["rgen"]}

                r_gen_dict = {"r_gen_train": res_train_dict["rproc"],
                              "r_gen_pred": res_pred_dict["rproc"]}
    ...
    # st.write(res_train_dict.keys(), res_pred_dict.keys())
