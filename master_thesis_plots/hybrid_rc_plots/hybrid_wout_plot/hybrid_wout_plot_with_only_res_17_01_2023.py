...
# dim-selection model:
# wrong_model = lambda x: sys_obj.iterate(x)[[0]]
...
abs_w_out_normal = abs_res_w_out_normal[:, :, :, 0: -1]
...
# mean over dim:
abs_w_out_normal_avg = np.mean(abs_w_out_normal, axis=3)
abs_w_out_hyb_res_avg = np.mean(abs_w_out_hyb_res, axis=3)
abs_w_out_hyb_kbm_avg = np.mean(abs_w_out_hyb_kbm, axis=3)

# median:
median_abs_w_out_normal_avg = np.median(abs_w_out_normal_avg, axis=(0, 1))
...
# low:
low_abs_w_out_normal_avg = np.quantile(abs_w_out_normal_avg, q=0.25, axis=(0, 1))
...
# high:
high_abs_w_out_normal_avg = np.quantile(abs_w_out_normal_avg, q=0.75, axis=(0, 1))
...
fig.add_traces([
    go.Bar(x=x,
           y=median_abs_w_out_normal_avg,
           error_y=dict(symmetric=False,
                        thickness=2,
                        width=6,
                        array=high_abs_w_out_normal_avg - median_abs_w_out_normal_avg,
                        arrayminus=median_abs_w_out_normal_avg - low_abs_w_out_normal_avg),
           marker_color="#C6C6C6",
           name="No hybrid"),
    go.Bar(x=x,
...
# SAVE
fig.write_image(f"hybrid_wout_plot_with_only_res.png", scale=3)
